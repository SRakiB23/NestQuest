      ...
      <div className="card lg:card-side bg-base-100 shadow-xl md:">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            revolutionize the industry through innovation and excellence. With a
            relentless commitment to integrity and customer satisfaction, we
      ...
      <div className="card lg:card-side bg-base-100 shadow-xl md: my-6">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            providing the ideal home solutions. With an unwavering dedication to
            integrity and customer satisfaction, he ensures clients find their
            perfect homes.
          </p>
          <p>
      ...
      <div className="card lg:card-side bg-base-100 pt-6 shadow-xl md:">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            personalized service to match clients with their dream homes. With a
            focus on integrity and client satisfaction, he delivers exceptional
